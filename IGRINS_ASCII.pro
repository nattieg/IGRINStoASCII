...
;put band in quotes
;file numbers don't have to be in quotes
...
openw,1,outname
printf,1,'# Code written by G. Mace, forked from Github.'
printf,1,'# Generated by N. Gosnell on '+SYSTIME()
...
print,'ASCII file has been saved with all orders,2048 rows each, in a single file.'
